...
Pardakht has a single Composer dependency — [`eram/abzar`](https://github.com/eramhq/abzar-php), the shared Persian/Iranian utility library — plus the PHP extensions that ship with most installations.
