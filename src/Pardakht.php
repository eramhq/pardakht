...
use EramDev\Pardakht\Gateway\NextPay\NextPayConfig;
use EramDev\Pardakht\Gateway\NextPay\NextPayGateway;
use EramDev\Pardakht\Gateway\Parsian\ParsianConfig;
use EramDev\Pardakht\Gateway\Parsian\ParsianGateway;
use EramDev\Pardakht\Gateway\Pasargad\PasargadConfig;
use EramDev\Pardakht\Gateway\Pasargad\PasargadGateway;
use EramDev\Pardakht\Gateway\PayIr\PayIrConfig;
use EramDev\Pardakht\Gateway\PayIr\PayIrGateway;
use EramDev\Pardakht\Gateway\Sadad\SadadConfig;
use EramDev\Pardakht\Gateway\Sadad\SadadGateway;
use EramDev\Pardakht\Gateway\Saman\SamanConfig;
use EramDev\Pardakht\Gateway\Saman\SamanGateway;
use EramDev\Pardakht\Gateway\Sizpay\SizpayConfig;
use EramDev\Pardakht\Gateway\Sizpay\SizpayGateway;
use EramDev\Pardakht\Gateway\Vandar\VandarConfig;
use EramDev\Pardakht\Gateway\Vandar\VandarGateway;
use EramDev\Pardakht\Gateway\Zarinpal\ZarinpalConfig;
use EramDev\Pardakht\Gateway\Zarinpal\ZarinpalGateway;
use EramDev\Pardakht\Gateway\Zibal\ZibalConfig;
use EramDev\Pardakht\Gateway\Zibal\ZibalGateway;
